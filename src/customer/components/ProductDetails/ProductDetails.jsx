    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6 ">
              ...
              <li key={breadcrumb.id}>
                <div className="flex items-center">
                  <a
                    ...
                    className="mr-2 text-left text-sm font-medium text-gray-900"
                  >
                    {breadcrumb.name}
                  </a>
                  <svg
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10">
          ...
          {/* Product info */}
          <div
            className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16
        sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24"
          >
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div
                className="flex space-x-5 items-center text-lg lg:text-xl
            text-gray-900 mt-6"
              >
            ...
            <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 
                    ...
                    <Grid item xs={5}>
                        ...
                        <Box className="mt-5 space-y-3">
                            <Grid container alignItems="center" gap={2}>
                                ...
                                height:7}} variant="determinate" value={40} color="success"/>
                            ...
                            <Grid container alignItems="center" gap={2}>
                                ...
                                <Grid item xs={7}>
                                    <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4,
                                height:7,color:"yellow"}} variant="determinate" value={25}/>
                            ...
                            <Grid container alignItems="center" gap={2}>
                                ...
                                <Grid item xs={7}>
                                    <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4,
                                height:7}} variant="determinate" value={20} color="warning"/>
                            ...
                            <Grid container alignItems="center" gap={2}>
                                ...
                                <Grid item xs={7}>
                                    <LinearProgress sx={{bgcolor:"#d0d0d0", borderRadius:4,
                                height:7}} variant="determinate" value={15} color="error"/>
